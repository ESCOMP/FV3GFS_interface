...
get_filename_component (C_COMPILER_NAME ${MPICC} NAME)
get_filename_component (CXX_COMPILER_NAME ${MPICXX} NAME)
get_filename_component (Fortran_COMPILER_NAME ${MPIFC} NAME)
...
if(32BIT)
    ...
    if(REPRO)
	message("here NOT ${REPRO}")
    else()
	set(CMAKE_Fortran_FLAGS "${CMAKE_Fortran_FLAGS} ${FC_FAST}")
    endif()
endif()
